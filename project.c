...
static GLint player_1= 1, player_2= 2;
...
void display(void) {
    ...
    snprintf (score_1, sizeof(score_1), "SCORES:\t %d", player1_score);
    drawStrokeText(score_1, -160, 370, 0);
    if(player1_score==3)
	 {
	 snprintf (score_1, sizeof(score_1), "WINNER PLAYER %d!!\t ", player_1);
    	drawStrokeText(score_1, -160, 270, 0);
    	}


    // draw the score on the left for player 1
    snprintf (score_2, sizeof(score_2), "%d", player2_score);
    drawStrokeText(score_2, 10, 370, 0);
    if(player2_score==3)
	 {
	 snprintf (score_2, sizeof(score_2), "WINNER PLAYER %d!!\t ", player_2);
    	drawStrokeText(score_2, -160, 270, 0);
    	}
